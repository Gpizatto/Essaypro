...
import { ScorePanel } from '../components/correction/ScorePanel';
  ...
  return (
    <div style={{ backgroundColor: '#FDF3E8', minHeight: '100vh' }}>
      ...
      <ScorePanel
        ...
        visibleAiErrors={visibleAiErrors}
        handleDismissError={handleDismissError}
        handleAddErrorAsComment={handleAddErrorAsComment}
        inlineComments={inlineComments}
        handleAnalyzeWithAI={handleAnalyzeWithAI}
        loadingAI={loadingAI}
        suggest_rewrite={suggest_rewrite}
        setSuggestRewrite={setSuggestRewrite}
        mark_important={mark_important}
        setMarkImportant={setMarkImportant}
        extra_material={extra_material}
        setExtraMaterial={setExtraMaterial}
