  ...
  return (
    <Layout>
      <div className="space-y-6">
        <div>
          <h1 className="font-heading font-black text-4xl" style={{ color: '#7C1805' }} data-testid="correction-queue-title">
            Fila de Correções
          </h1>
              ...
              <Card key={essay.id} className="p-6 bg-white border shadow-sm hover:shadow-md transition-shadow" data-testid={`queue-essay-${essay.id}`}>
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    <h3 className="font-heading text-xl font-semibold mb-2" style={{ color: '#7C1805' }}>
